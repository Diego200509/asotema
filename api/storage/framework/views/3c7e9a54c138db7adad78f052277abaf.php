...
<body>
    ...
    <div class="calculations">
        ...
        ?>
        <div>LOSER= <?php echo e(number_format($descuentos['totales']['ahorro'] + $descuentos['totales']['gastos_eventos'] + $totalCuotas, 2, ',', '.')); ?></div>
        <div>CT = <?php echo e(number_format($totalCuotas, 0)); ?></div>
        <div style="border-top: 1px solid #666; margin-top: 2px; padding-top: 2px;"><?php echo e(number_format($descuentos['totales']['total'], 2, ',', '.')); ?> //</div>
    </div>
</body>
</html>
