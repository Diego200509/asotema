...
<body>
    ...
    <div class="socio-info">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value"><?php echo e($socio->nombres); ?> <?php echo e($socio->apellidos); ?></span>
            </div>
            <div class="info-item">
            ...
            <?php $__currentLoopData = $prestamos->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prestamo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="prestamo-detalle">
                    ...
                    <div class="prestamo-header">
                        Préstamo #<?php echo e($prestamo->id); ?> - $<?php echo e(number_format($prestamo->capital, 2)); ?>
                    ...
                    <div class="prestamo-info">
                        <div class="info-item-detalle">
                            ...
                            <div class="value">$<?php echo e(number_format($prestamo->capital, 2)); ?></div>
                        </div>
                        <div class="info-item-detalle">
                            <div class="label">Tasa Interés</div>
                            <div class="value"><?php echo e(number_format($prestamo->tasa_mensual * 100, 2)); ?>%</div>
                        </div>
                        <div class="info-item-detalle">
                            <div class="label">Plazo</div>
                            <div class="value"><?php echo e($prestamo->plazo_meses); ?> meses</div>
                        </div>
                        <div class="info-item-detalle">
                    ...
                    <div class="prestamo-info" style="background-color: #f0f9ff;">
                        <div class="info-item-detalle">
                            ...
                            <div class="value"><?php echo e(count($prestamo->cuotas ?? [])); ?></div>
                        </div>
                        <div class="info-item-detalle">
                            <div class="label">Cuotas Pagadas</div>
                            <div class="value" style="color: #16a34a;">
                                <?php echo e(collect($prestamo->cuotas ?? [])->filter(function($cuota) { return $cuota->estado === 'PAGADA'; })->count()); ?>
                        ...
                        <div class="info-item-detalle">
                            ...
                            <div class="value" style="color: #dc2626;">
                                <?php echo e(collect($prestamo->cuotas ?? [])->filter(function($cuota) { return $cuota->estado === 'PENDIENTE' || $cuota->estado === 'PARCIAL'; })->count()); ?>
                        ...
                        <div class="info-item-detalle">
                            ...
                            <div class="value" style="color: #16a34a;">
                                $<?php echo e(number_format(collect($prestamo->cuotas ?? [])->sum('monto_pagado'), 2)); ?>
                    ...
                    <?php if(isset($prestamo->cuotas) && count($prestamo->cuotas) > 0): ?>
                        <table class="cuotas-table">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $prestamo->cuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cuota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="fecha"><?php echo e($cuota->numero_cuota); ?></td>
                                        <td class="fecha"><?php echo e(\Carbon\Carbon::parse($cuota->fecha_vencimiento)->format('d/m/Y')); ?></td>
                                        <td class="monto">$<?php echo e(number_format($cuota->monto_esperado, 2)); ?></td>
                                        <td class="monto">$<?php echo e(number_format($cuota->parte_interes, 2)); ?></td>
                                        <td class="monto">$<?php echo e(number_format($cuota->parte_capital, 2)); ?></td>
                                        <td class="monto" style="color: #16a34a;">$<?php echo e(number_format($cuota->monto_pagado, 2)); ?></td>
                                        <td class="monto" style="color: #dc2626;">$<?php echo e(number_format($cuota->monto_esperado - $cuota->monto_pagado, 2)); ?></td>
                                        <td>
                                            <span class="estado-badge <?php echo e(strtolower($cuota->estado)); ?>">
    ...
    <div class="footer">
        ...
        <p>Este documento fue generado automáticamente el <?php echo e(\Carbon\Carbon::now('America/Guayaquil')->format('d/m/Y H:i:s')); ?></p>
    </div>
</body>
</html>
